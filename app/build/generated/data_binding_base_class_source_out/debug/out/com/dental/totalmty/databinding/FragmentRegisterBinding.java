...
public final class FragmentRegisterBinding implements ViewBinding {
  ...
  private FragmentRegisterBinding(@NonNull ScrollView rootView, @NonNull ImageButton btnBack,
      ...
      @NonNull TextView tvError, @NonNull TextView tvLogin) {
  ...
  public static FragmentRegisterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRegisterBinding((ScrollView) rootView, btnBack, btnRegister,
          etConfirmPassword, etEmail, etNombre, etPassword, etTelefono, progressBar,
          tilConfirmPassword, tilEmail, tilNombre, tilPassword, tilTelefono, tvError, tvLogin);
    }
